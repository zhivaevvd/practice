...
internal enum Asset {
  ...
  internal static let greenBack = ColorAsset(name: "green.back")
  ...
  internal static let saleOne = ImageAsset(name: "sale.one")
  internal static let saleThree = ImageAsset(name: "sale.three")
